...
document.querySelector('#button-sidebar > .button-text').textContent = browser.i18n.getMessage('buttonSidebar');
document.querySelector('#button-sidebar').title = browser.i18n.getMessage('buttonSidebar');
...
document.querySelector('#button-sidebar').addEventListener('click', (ev) => {
