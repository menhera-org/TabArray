...
export const ISSUES_PAGE = 'https://github.com/menhera-org/TabArray/issues';
...
export const CTG_OFFCIAL_SIGNATURE_URL = 'https://downloads.menhera.org/ctg-metadata/%VERSION%/%HASH%.signed.json';
